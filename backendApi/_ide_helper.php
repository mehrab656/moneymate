 ...
 */
     ...
     */
        ...
        {
                        /** @var \Illuminate\Auth\SessionGuard $instance$instance */
     ...
     */
         ...
         *                                      the driver supports TTL then the Libraries may set a default value
     ...
     */
         ...
         *
         * It works if your JavaScript Libraries sets an X-Requested-With HTTP header.
        ...
        {            //Method inherited from \Symfony\Component\HttpFoundation\Request
                    ...
                    /**
         * IncomeFilter the given array of rules into an array of rules that are included in precognitive headers.
         *
         * @param array $rules
         * @return array
         * @static
