        ...
        {!loading && (
          <form onSubmit={onSubmit} className="custom-form">
              ...
              <Col xs={12} md={6}>
                <div className="form-group">
                  <InputGroup className="mb-3" size="sm">
                    <InputGroup.Text id="role_name" style={inputGroupTextStyle}>
                      Role Name
                    </InputGroup.Text>
                    <Form.Control
                      ...
                      size="sm"
                      value={role.name}
                      onChange={(ev) => setRole({ ...role, name: ev.target.value })}
                      placeholder="Search By Name..."
                      style={{ ...inputStyle, textTransform: "capitalize", flex: 1 }}
                    />
                  </InputGroup>
                  {errors?.name && (
            ...
            <div className="text-end mt-2">
              <button className="custom-btn btn-brand-primary role-btn btn-edit px-5">
                {id ? "Update" : "Create"}
              </button>
            </div>
          </form>
