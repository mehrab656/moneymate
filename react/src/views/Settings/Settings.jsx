...
export default function Settings() {
    ...
    const sectionBody = (eventKey)=>{
        if (eventKey==="profile"){
            return (<> <ProfileTab settings={settings}
            handleFunc={handleChange}
            submit={applicationSettingsSubmit}/> </>)}
        if (eventKey==="company"){ return (<><CompanyTab settings={settings}
                                                         handleFunc={handleChange}
                                                         submit={applicationSettingsSubmit}/></>)}
        if (eventKey==="general"){ return (<><GeneralTab settings={settings}
                                                         handleFunc={handleChange}
                                                         submit={applicationSettingsSubmit}/></>)}
        if (eventKey==="integration"){ return (<><IntegrationTab settings={settings}
                                                             handleFunc={handleChange}
                                                             submit={applicationSettingsSubmit}/></>)}
        if (eventKey==="notification"){ return (<> <ProfileTab settings={settings}
                                                               handleFunc={handleChange}
                                                               submit={applicationSettingsSubmit}/></>)}
    }
