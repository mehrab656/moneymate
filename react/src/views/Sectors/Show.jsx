...
export default function Show({handleCloseModal,element,currency}){
    ...
    const {
        ...
        isFetching: isIncomeAndExpenseFetching,
            ...
            <Modal.Body>
                <table className="table table-bordered border-primary ">
                    ...
                    <tr>
                        ...
                        <td>{element?.rent}</td>
                        <td><strong>Contract Remaining</strong></td>
                        <td>{remainingContract(element.contract_end_date)}</td>
                    </tr>
                    <tr>
                        <td><strong>Contract Started</strong></td>
