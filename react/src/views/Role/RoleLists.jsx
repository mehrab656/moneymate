            ...
            <Table sx={{minWidth: 650}} size="small" aria-label="a dense table">
                ...
                {moduleArray &&
                    moduleArray.map((menu, i) => {
                        const mainModule = toTitleCase(menu[0]);
                        const subModule = Object.entries(menu[1]);
                        const rows = [
                        ...
                        return (
                            <>
                                <TableBody>
                                    <TableRow
                                        key={mainModule+Math.random().toString(36).substring(2)}
                                        ...
                                        {subModule.map((option, key) => {
                                            const label = option[0].split("_").pop()
                                            return (
                                                <TableCell align="right">
                                                    <FormControlLabel
                                                        key={option[0]+Math.random().toString(36).substring(2)}
                                                        control={
                                                            <Checkbox
                                                                checked={option[1]}
