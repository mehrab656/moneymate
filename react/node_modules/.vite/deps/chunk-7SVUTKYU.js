...
var Portal = React28.forwardRef(function Portal2(props, forwardedRef) {
  ...
  if (disablePortal) {
    ...
    return (0, import_jsx_runtime14.jsx)(React28.Fragment, {
      children
    });
  }
  return (0, import_jsx_runtime14.jsx)(React28.Fragment, {
...
var TransitionContext = React29.createContext(null);

// node_modules/@mui/base/useTransition/useTransitionStateManager.js
function useTransitionStateManager() {
  const transitionContext = React30.useContext(TransitionContext);
...
function useTransitionTrigger(requestEnter) {
  const [exitTransitionFinished, setExitTransitionFinished] = React31.useState(true);
  const hasPendingExitTransition = React31.useRef(false);
  const registeredTransitions = React31.useRef(0);
  const [hasTransition, setHasTransition] = React31.useState(false);
  const previousRequestEnter = React31.useRef(requestEnter);
  React31.useEffect(() => {
  ...
  const handleExited = React31.useCallback(() => {
    hasPendingExitTransition.current = false;
    setExitTransitionFinished(true);
  }, []);
  const registerTransition = React31.useCallback(() => {
...
var PopupContext = React32.createContext(null);
...
var Popup = React33.forwardRef(function Popup2(props, forwardedRef) {
  var _slots$root;
  const {
    anchor: anchorProp,
    children,
  ...
  const popupContextValue = React33.useMemo(() => ({
    placement: finalPlacement
  }), [finalPlacement]);
...
function NoSsr(props) {
  ...
  return (0, import_jsx_runtime21.jsx)(React42.Fragment, {
...
var Slider = React54.forwardRef(function Slider2(props, forwardedRef) {
  ...
  return (0, import_jsx_runtime32.jsxs)(Root, _extends({}, rootProps, {
    children: [(0, import_jsx_runtime31.jsx)(Rail, _extends({}, railProps)), (0, import_jsx_runtime31.jsx)(Track, _extends({}, trackProps)), marks.filter((mark) => mark.value >= min && mark.value <= max).map((mark, index2) => {
      ...
      return (0, import_jsx_runtime32.jsxs)(React54.Fragment, {
...
function NextPageIconDefault() {
  return _span32 || (_span32 = (0, import_jsx_runtime36.jsx)("span", {
    children: "⇾"
  }));
}
...
var TextareaAutosize = React72.forwardRef(function TextareaAutosize2(props, forwardedRef) {
  ...
  return (0, import_jsx_runtime47.jsxs)(React72.Fragment, {
    children: [(0, import_jsx_runtime46.jsx)("textarea", _extends({
      value,
      onChange: handleChange,
      ref: handleRef,
      rows: minRows,
    ...
    }, other)), (0, import_jsx_runtime46.jsx)("textarea", {
      "aria-hidden": true,
...
function GlobalStyles(props) {
  return (0, import_jsx_runtime50.jsx)(GlobalStyles_default, _extends({}, props, {
...
var InputBase = React77.forwardRef(function InputBase2(inProps, ref) {
  ...
  return (0, import_jsx_runtime52.jsxs)(React77.Fragment, {
    children: [!disableInjectingGlobalStyles && inputGlobalStyles, (0, import_jsx_runtime52.jsxs)(Root, _extends({}, rootProps, !isHostComponent(Root) && {
      ...
      children: [startAdornment, (0, import_jsx_runtime51.jsx)(FormControlContext_default.Provider, {
        value: null,
        children: (0, import_jsx_runtime51.jsx)(Input3, _extends({
          ownerState,
...
var OutlinedInput = React78.forwardRef(function OutlinedInput2(inProps, ref) {
  ...
  return (0, import_jsx_runtime54.jsx)(InputBase_default, _extends({
    ...
    renderSuffix: (state) => (0, import_jsx_runtime54.jsx)(NotchedOutlineRoot2, {
      ...
      label: label != null && label !== "" && fcs.required ? _React$Fragment || (_React$Fragment = (0, import_jsx_runtime53.jsxs)(React78.Fragment, {
        children: [label, " ", "*"]
      })) : label,
...
@mui/base/index.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-7SVUTKYU.js.map
