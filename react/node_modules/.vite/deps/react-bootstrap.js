import {
  ...
  useMounted,
  usePrevious
} from "./chunk-HX35DLBG.js";
import {
  require_warning
} from "./chunk-FASBDCVJ.js";
import {
  _setPrototypeOf
} from "./chunk-DMHJNZZW.js";
import {
  Badge_default
} from "./chunk-SGWR6BCZ.js";
import {
  DEFAULT_BREAKPOINTS,
  ...
  useBootstrapPrefix,
  useIsRTL
} from "./chunk-2I6HWBSI.js";
import {
  require_classnames
} from "./chunk-5GGVA7LZ.js";
import {
  arrow_default,
...
} from "./chunk-SD43I2LC.js";
import {
  _extends,
  _objectWithoutPropertiesLoose,
  init_extends,
  init_objectWithoutPropertiesLoose
} from "./chunk-ET25OCK3.js";
import {
  require_jsx_runtime
} from "./chunk-YUCKK6LQ.js";
import {
  require_prop_types
} from "./chunk-KZXUN7EH.js";
import {
  require_react_dom
...
function $704cf1d3b684cc5c$export$9f8ac96af4b1b2ae(props) {
  ...
  return (0, import_react26.default).createElement($704cf1d3b684cc5c$var$LegacySSRProvider, props);
}
...
function $704cf1d3b684cc5c$var$useModernSSRSafeId(defaultId) {
  ...
  let [didSSR] = (0, import_react26.useState)($704cf1d3b684cc5c$export$535bd6ca7f90a273());
  let prefix = didSSR ? "react-aria" : `react-aria${$704cf1d3b684cc5c$var$defaultContext.prefix}`;
  return defaultId || `${prefix}-${id}`;
}
var $704cf1d3b684cc5c$export$619500959fc48b26 = typeof (0, import_react26.default)["useId"] === "function" ? $704cf1d3b684cc5c$var$useModernSSRSafeId : $704cf1d3b684cc5c$var$useLegacySSRSafeId;
...
function $704cf1d3b684cc5c$export$535bd6ca7f90a273() {
  if (typeof (0, import_react26.default)["useSyncExternalStore"] === "function")
    return (0, import_react26.default)["useSyncExternalStore"]($704cf1d3b684cc5c$var$subscribe, $704cf1d3b684cc5c$var$getSnapshot, $704cf1d3b684cc5c$var$getServerSnapshot);
  let cur = (0, import_react26.useContext)($704cf1d3b684cc5c$var$SSRContext);
  return cur.isSSR;
}
...
function Dropdown({
  ...
  const context6 = (0, import_react30.useMemo)(() => ({
    toggle,
    placement,
    show,
    menuElement,
...
var Container = React61.forwardRef(({
  bsPrefix,
  fluid = false,
  // Need to define the default "as" during prop destructuring to be compatible with styled-components github.com/react-bootstrap/react-bootstrap/issues/3595
  as: Component2 = "div",
...
var TabContext = React65.createContext(null);
...
var NavItem = React66.forwardRef((_ref, ref) => {
  let {
    as: Component2 = Button_default,
    active,
    eventKey
...
var Nav = React67.forwardRef((_ref, ref) => {
  let {
    // Need to define the default "as" during prop destructuring to be compatible with styled-components github.com/react-bootstrap/react-bootstrap/issues/3595
    as: Component2 = "div",
    onSelect,
  ...
  const forceUpdate = useForceUpdate();
  const needsRefocusRef = (0, import_react45.useRef)(false);
  ...
  const listNode = (0, import_react45.useRef)(null);
...
var ListGroupItem = React68.forwardRef(({
  bsPrefix,
  active,
  disabled,
  eventKey,
...
var ListGroup = React69.forwardRef((props, ref) => {
  const {
    className,
...
function useTransition({
  ...
  const isInitialRef = (0, import_react48.useRef)(true);
...
function ImperativeTransition({
  ...
  const [exited, setExited] = (0, import_react48.useState)(!inProp);
  if (inProp && exited) {
    setExited(false);
  }
  ...
  const combinedRef = useMergedRefs_default(ref, children.ref);
  return exited && !inProp ? null : (0, import_react48.cloneElement)(children, {
    ref: combinedRef
  });
}
...
function useModalManager(provided) {
  ...
  const modal = (0, import_react49.useRef)({
    dialog: null,
    backdrop: null
  });
  return Object.assign(modal.current, {
    ...
    setDialogRef: (0, import_react49.useCallback)((ref) => {
      modal.current.dialog = ref;
    }, []),
    setBackdropRef: (0, import_react49.useCallback)((ref) => {
      modal.current.backdrop = ref;
    }, [])
  });
}
var Modal = (0, import_react49.forwardRef)((_ref, ref) => {
  let {
    show = false,
    role = "dialog",
    className,
  ...
  const [exited, setExited] = (0, import_react49.useState)(!show);
  const lastFocusRef = (0, import_react49.useRef)(null);
  (0, import_react49.useImperativeHandle)(ref, () => modal, [modal]);
  ...
  const removeFocusListenerRef = (0, import_react49.useRef)();
  const removeKeydownListenerRef = (0, import_react49.useRef)();
...
var AbstractModalHeader = React74.forwardRef(({
  ...
  const context6 = (0, import_react50.useContext)(ModalContext_default);
...
var Modal2 = React76.forwardRef(({
  ...
  const [modalStyle, setStyle] = (0, import_react51.useState)({});
  const [animateStaticModal, setAnimateStaticModal] = (0, import_react51.useState)(false);
  const waitingForMouseUpRef = (0, import_react51.useRef)(false);
  const ignoreBackdropClickRef = (0, import_react51.useRef)(false);
  const removeStaticModalAnimationRef = (0, import_react51.useRef)(null);
  ...
  const renderBackdrop = (0, import_react51.useCallback)((backdropProps) => (0, import_jsx_runtime72.jsx)("div", {
    ...backdropProps,
...
var Nav2 = React78.forwardRef((uncontrolledProps, ref) => {
  ...
  let isNavbar = false;
  const navbarContext = (0, import_react52.useContext)(NavbarContext_default);
  const cardHeaderContext = (0, import_react52.useContext)(CardHeaderContext_default);
  if (navbarContext) {
...
var Offcanvas = React84.forwardRef(({
  ...
  const renderBackdrop = (0, import_react57.useCallback)((backdropProps) => (0, import_jsx_runtime80.jsx)("div", {
    ...backdropProps,
...
function useOverlayOffset(customOffset) {
  ...
  const offset = (0, import_react62.useMemo)(() => ({
    name: "offset",
    options: {
      offset: () => {
        if (customOffset) {
...
function OverlayTrigger({
  ...
  return (0, import_jsx_runtime94.jsxs)(import_jsx_runtime93.Fragment, {
    children: [typeof children === "function" ? children(triggerProps) : (0, import_react64.cloneElement)(children, triggerProps), (0, import_jsx_runtime92.jsx)(Overlay_default2, {
      ...props,
      show,
      onHide: handleHide,
      flip,
...
var PlaceholderButton = React94.forwardRef((props, ref) => {
...
var Placeholder = React95.forwardRef(({
  as: Component2 = "span",
  ...props
}, ref) => {
  const placeholderProps = usePlaceholder(props);
...
var ProgressBar = React96.forwardRef(({
  isChild = false,
  ...rest
}, ref) => {
  const props = {
...
var Ratio = React97.forwardRef(({
  ...
  return (0, import_jsx_runtime98.jsx)("div", {
    ...
    children: React97.Children.only(children)
  });
});
  ...
  (_ref2, ref) => {
    ...
    return (0, import_jsx_runtime104.jsx)(TabContext_default.Provider, {
      ...
      children: (0, import_jsx_runtime104.jsx)(SelectableContext_default.Provider, {
        value: null,
        children: (0, import_jsx_runtime104.jsx)(Transition2, {
          in: isActive,
          onEnter,
          onEntering,
          onEntered,
...
var TabPane = React105.forwardRef(({
  bsPrefix,
  transition,
  ...props
}, ref) => {
...
var ToastFade = React109.forwardRef((props, ref) => (0, import_jsx_runtime113.jsx)(Fade_default, {
  ...props,
  ref,
...
var ToastHeader = React111.forwardRef(({
  ...
  const context6 = (0, import_react68.useContext)(ToastContext_default);
  const handleClick = useEventCallback((e) => {
...
var Toast = React112.forwardRef(({
  ...
  return (0, import_jsx_runtime116.jsx)(ToastContext_default.Provider, {
    value: toastContext,
    children: hasAnimation && Transition2 ? (0, import_jsx_runtime116.jsx)(Transition2, {
      in: show,
      unmountOnExit: true,
      children: toast
    }) : toast
...
var ToastContainer = React113.forwardRef(({
  bsPrefix,
  position,
  containerPosition,
  className,
...
var noop7 = () => void 0;
var ToggleButton = React114.forwardRef(({
  bsPrefix,
  name,
  className,
  checked,
...
var ToggleButtonGroup = React115.forwardRef((props, ref) => {
  const {
    children,
    type = "radio",
    name,
