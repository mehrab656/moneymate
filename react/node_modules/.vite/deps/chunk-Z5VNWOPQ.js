import {
  createPopper,
  init_lib
} from "./chunk-XMZ2ZRLA.js";
import {
  init_emotion_is_prop_valid_esm,
  isPropValid,
  require_react_is
} from "./chunk-XOILSLME.js";
import {
  CacheProvider,
  Global,
  ThemeContext,
...
var React67, testOmitPropsOnStringTag, testOmitPropsOnComponent, getDefaultShouldForwardProp, composeShouldForwardProps, ILLEGAL_ESCAPE_SEQUENCE_ERROR, Insertion, createStyled;
      ...
      return function() {
        ...
        var Styled = withEmotionCache(function(props, cache2, ref) {
          ...
          if (props.theme == null) {
            ...
            mergedProps.theme = React67.useContext(ThemeContext);
          }
          ...
          }), React67.createElement(FinalTag, newProps));
        });
...
var React68, import_prop_types28, import_jsx_runtime42, cache;
...
var React69, import_prop_types29, import_jsx_runtime43;
...
function useTheme(defaultTheme5 = null) {
  const contextTheme = React70.useContext(ThemeContext);
  return !contextTheme || isObjectEmpty(contextTheme) ? defaultTheme5 : contextTheme;
}
var React70, useThemeWithoutDefault_default;
...
var React71, import_prop_types32, import_jsx_runtime44;
...
function createBox(options = {}) {
  ...
  const Box2 = React72.forwardRef(function Box3(inProps, ref) {
...
var React72, import_jsx_runtime45, _excluded27;
...
var React73, ThemeContext2, ThemeContext_default;
var init_ThemeContext = __esm({
  "node_modules/@mui/private-theming/useTheme/ThemeContext.js"() {
    React73 = __toESM(require_react());
    ThemeContext2 = React73.createContext(null);
    if (true) {
...
function useTheme3() {
  const theme = React74.useContext(ThemeContext_default);
  if (true) {
...
var React75, import_prop_types34, import_jsx_runtime46, ThemeProvider_default;
...
var React76, import_prop_types35, import_jsx_runtime47, EMPTY_THEME;
...
var React79, import_prop_types36, import_jsx_runtime49, import_jsx_runtime50;
...
function createContainer(options = {}) {
  ...
  const Container2 = React80.forwardRef(function Container3(inProps, ref) {
...
var React80, import_prop_types37, import_jsx_runtime51, _excluded30, defaultTheme, defaultCreateStyledComponent, useThemePropsDefault, useUtilityClasses20;
...
function createGrid(options = {}) {
  ...
  const OverflowContext = React81.createContext(void 0);
  ...
  const Grid2 = React81.forwardRef(function Grid3(inProps, ref) {
    var _inProps$columns, _inProps$spacing, _ref, _inProps$rowSpacing, _ref2, _inProps$columnSpacin, _ref3, _disableEqualOverflow;
    const theme = useTheme_default();
    const themeProps = useThemeProps3(inProps);
    const props = extendSxProp(themeProps);
    const overflow2 = React81.useContext(OverflowContext);
    const {
      className,
      children,
    ...
    let result = (0, import_jsx_runtime52.jsx)(GridRoot, _extends({
      ...
      children: React81.Children.map(children, (child) => {
        if (React81.isValidElement(child) && isMuiElement(child, ["Grid"])) {
...
var React81, import_prop_types39, import_jsx_runtime52, _excluded31, defaultTheme2, defaultCreateStyledComponent2;
...
function joinChildren(children, separator) {
  ...
  return childrenArray.reduce((output, child, index) => {
    ...
    if (index < childrenArray.length - 1) {
      output.push(React82.cloneElement(separator, {
        key: `separator-${index}`
      }));
    }
    return output;
...
function createStack(options = {}) {
  ...
  const Stack2 = React82.forwardRef(function Grid2(inProps, ref) {
    const themeProps = useThemeProps3(inProps);
    const props = extendSxProp(themeProps);
    const {
      component = "div",
...
var React82, import_prop_types41, import_jsx_runtime53, _excluded32, defaultTheme3, defaultCreateStyledComponent3, getSideFromDirection, style3;
...
var React83, import_prop_types43, import_jsx_runtime54, import_jsx_runtime55, _excluded37, useUtilityClasses21, SvgIconRoot, SvgIcon, SvgIcon_default;
var init_SvgIcon = __esm({
  "node_modules/@mui/material/SvgIcon/SvgIcon.js"() {
    ...
    SvgIcon = React83.forwardRef(function SvgIcon2(inProps, ref) {
      ...
      const hasSvgAsChild = React83.isValidElement(children) && children.type === "svg";
      const ownerState = _extends({}, props, {
        color: color2,
        component,
        fontSize: fontSize2,
...
function createSvgIcon(path, displayName) {
  ...
  return React84.memo(React84.forwardRef(Component));
}
var React84, import_jsx_runtime56;
...
@mui/private-theming/index.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-Z5VNWOPQ.js.map
